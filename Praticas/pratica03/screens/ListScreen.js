    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.item}>
                <Text style={styles.itemTitle}>Título do item</Text>
            ...
            <View style={styles.item}>
                ...
                <Text style={styles.itemTitle}>Descrição breve do item 3.</Text>
            </View>
            <View style={styles.item}>
                <Text style={styles.itemTitle}>Título do Item 3</Text>
                <Text style={styles.itemTitle}>Descrição breve do item 3.</Text>
...
const styles = StyleSheet.create({
    ...
    appTitle: { color: "#FFFFFF", fontSize: 22, fontWeight: "400", lineHeight: 28, alignSelf: "center", }, item: { backgroundColor: "FEF7FF", height: 72, borderBottomWidth: 1, borderBottomColor: "79747E", paddingTop: 8, paddingLeft: 16, paddingRight: 16, paddingBottom: 8, },
